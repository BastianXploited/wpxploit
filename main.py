...
def banner():
    clear_screen()
    print(f"{CYAN}{'='*65}")
    print(f"{BRIGHT}{WHITE}   MASS EXPLOIT - WORDPRESS AUTH BYPASS RESEARCH")
    print(f"{CYAN}{'='*65}")
    print(f"{YELLOW} Author     : {WHITE}BastianXploited - Security Researcher")
    print(f"{YELLOW} GitHub     : {WHITE}https://github.com/BastianXploited")
